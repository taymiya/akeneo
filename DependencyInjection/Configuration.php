    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('textheader')->defaultValue('Text')->end()
                ->scalarNode('logoupload')->defaultValue('File')->end()
                ->scalarNode('logosize')->defaultValue(100)->end()
                ->scalarNode('titleheader')->defaultValue('Title')->end()
                ->scalarNode('marginheader')->defaultValue('10')->end()
                ->scalarNode('marginfooter')->defaultValue('10')->end()
            ->end()
        ;
