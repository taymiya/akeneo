...
class PDFTemplateType extends AbstractType
{
     ...
     */
    public function __construct(ConfigManager $userConfig,RouterInterface $router ,FamilyRepository $familyRepository)
    {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add(
            ...
            array(
                ...
                'expanded' => true,
                'choices'  => array(
                    'html' => 'ibnab.pmanager.pdftemplate.type.html',
                    'txt'  => 'ibnab.pmanager.pdftemplate.type.text'
                ),
                'required' => true
            )
        );
